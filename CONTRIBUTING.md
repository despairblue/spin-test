...
- Create a tag with the version found in `ls.opam`, and push it to your repository.
...
The following snippet describes ls's repository structure.
...
│
├── bin/
|   Source for ls's binary. This links to the library defined in `lib/`.
│
├── lib/
|   Source for ls's library. Contains ls's core functionnalities.
│
├── test/
|   Unit tests and integration tests for ls.
│
├── dune-project
